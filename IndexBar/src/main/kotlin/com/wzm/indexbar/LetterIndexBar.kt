...
class LetterIndexBar : View {
     ...
     * @return
     */
    fun setLetters(letters: List<String>): LetterIndexBar {
    ...
    interface OnSideBarListener {
        fun onSideTouchState(letterIndexBar: LetterIndexBar?, isTouch: Boolean)
        fun onSideSelected(
     ...
     * @return SideBarView
     */
    fun setSideBarListener(onSideBarListener: OnSideBarListener?): LetterIndexBar {
        this.onSideBarListener = onSideBarListener
        return this
    }

    fun updateSideBarItem(word: String) {
        if (onSideBarListener != null) {
            for (i in letters.indices) {
                if (word == letters[i]) {
                    choosePosition = i
